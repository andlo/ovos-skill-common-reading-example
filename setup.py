...
URL = "https://github.com/andlo/ovos-skill-common-reading-example"
SKILL_CLAZZ = "CommonReadingExample"  # needs to match __init__.py class name
PYPI_NAME = "ovos-skill-common-reading-example"  # pip install PYPI_NAME
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description="Template/example provider skill for ovos-skill-common-reading - copy and adapt, don't install as-is",
    ...
    keywords="ovos skill voice assistant template example provider",
